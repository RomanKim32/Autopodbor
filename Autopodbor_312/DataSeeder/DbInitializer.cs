    ...
    public class DbInitializer
	{
        public static void SeedDatabase(AutopodborContext context)
        {
            if (!context.Services.Any())
            {
                ...
                {
                    new Services { Name = "Подбор под ключ", Description = "Описание услуги подбора под ключ", IsAdditional = false, Photo = "/serviceImg/tree-736885__480.jpg", KeyForDescriptionInResourcesFiles = "serviceDescription1", KeyForNameInResourcesFiles = "serviceName1"},
                    new Services { Name = "Выездной осмотр", Description = "Описание услуги выезной осмотр", IsAdditional = false, Photo = "/serviceImg/tree-736885__480.jpg", KeyForDescriptionInResourcesFiles = "serviceDescription2", KeyForNameInResourcesFiles = "serviceName2" },
                    new Services { Name = "Дополнительные услуги", Description = "Описание дополнительных услуг" , IsAdditional = false, Photo = "/serviceImg/Add.jpg", KeyForDescriptionInResourcesFiles = "serviceDescription3", KeyForNameInResourcesFiles = "serviceName3"},
